...
fib.addEventListener("click", console.log(fibonacci(5)));

var gg = document.getElementById("gcd");
rS.addEventListener("click", console.log(gcd(40,30)));

var Rs = document.getElemenyById("rand");
Rs.addEventListener("click", console.log(randomStudent()));
